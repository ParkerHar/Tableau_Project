...
## Future Goals
Moving forward I would like to gather information on successful flights to create better risk assessment. As of this time, the dataset only contains flights where a strike did occur which makes it difficult to determine if certain times are truly a higher risk of strikes, or if those are just busier times for flights.
